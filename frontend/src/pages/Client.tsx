...
//                 disabled={
//                   !deviceStatus.isOnline || connectionStatus !== "connected"
//                 }
//               />
//             </div>
...
export default function Client() {
  ...
  useEffect(() => {
    ...
    const streamUrl = `http://localhost:3000/api/stream?deviceName=${deviceName}`;
    ...
    eventSource.addEventListener("temperature_data", (e) => {
      const data = JSON.parse((e as MessageEvent).data);
      console.log("🌡️ Temp update:", data);
      setDeviceStatus((prev) => ({
        ...prev,
        isOnline: true,
        temperature: data.temperature,
